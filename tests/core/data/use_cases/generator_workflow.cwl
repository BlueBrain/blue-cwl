...
steps:
    - id: stage_cell_composition
      ...
      run:
          ...
          executor:
            ...
            env_vars:
              FOO: foo
          baseCommand: ["cwl-registry", "stage", "cell-composition"]
          inputs:
            - id: cell_composition
              type: NexusType
              inputBinding:
    ...
    - id: stage_variant_config
      ...
      run:
          ...
          executor:
            ...
            remote_config:
              host: bbpv1.epfl.ch
          baseCommand: ["cwl-registry", "stage", "variant-config"]
          inputs:
            - id: variant_config
              type: NexusType
              inputBinding:
    ...
    - id: neurons_cell_position
      ...
      run:
          ...
          executor:
            ...
            remote_config:
              host: bbpv1.epfl.ch
          baseCommand: ["cwl-registry", "execute", "placement"]
          inputs:
            - id: cell_composition
              type: File
              inputBinding:
    ...
    - id: register
      ...
      run:
        cwlVersion: v1.2
        class: CommandLineTool
        baseCommand: ["cwl-registry", "register", "circuit"]
        inputs:
          - id: cell_composition
            type: NexusType
            inputBinding:
