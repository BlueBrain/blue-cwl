import pytest
from cwl_luigi.core import resolve as test_module
from cwl_luigi.core.cwl_types import File, Directory
from cwl_luigi.core.exceptions import ReferenceResolutionError
