...
import cwl_luigi.core.cwl
from cwl_luigi.core.common import CustomBaseModel
from cwl_luigi.core.cwl_types import Directory, File, NexusResource
from cwl_luigi.core.exceptions import CWLError
from cwl_luigi.core.executor import Executor, LocalExecutor
from cwl_luigi.core.resolve import resolve_parameter_references
from cwl_luigi.core.types import EnvVarDict, InputValue, InputValueObject, OutputValueObject

L = logging.getLogger(__name__)

if TYPE_CHECKING:
    from cwl_luigi.core.cwl import CommandLineTool, Workflow
...
def _cmd_elements(type_, binding, value) -> tuple | list[tuple] | None:
    ...
    match type_:
        ...
        case cwl_luigi.core.cwl.CommandInputArraySchema():
