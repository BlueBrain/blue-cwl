...
import cwl_luigi.core.process
from cwl_luigi.core.common import CustomBaseModel
from cwl_luigi.core.cwl_types import CWLType
from cwl_luigi.core.executor import LocalExecutor, SallocExecutor
...
class CommandLineTool(CustomBaseModel):
    ...
    def make(self, input_values: dict):
        ...
        return cwl_luigi.core.process.build_command_line_tool_process(self, input_values)
...
class Workflow(CustomBaseModel):
    ...
    def make(self, input_values):
        ...
        return cwl_luigi.core.process.build_workflow_process(self, input_values)

    def make_workflow_step(self, step_name, input_values, sources):
        """Make workflow step."""
        return cwl_luigi.core.process.build_workflow_step_process(
